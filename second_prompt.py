...
json_file_path = '/Users/ericsunkuan/Desktop/NTUEE/112-1/RL/final_project/llm/first_prompt_content.json'
...
# print(r1)
# print(pars('['+r1+']'))
with open(f"second_prompt_action_no6.json", "+w", encoding="utf-8") as f:
